...
<head>
<title>View and Authorize Auditors</title>
      ...
      <div class="sb_menu">
        <div class="gadget">
          <table width="544" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="536"><span class="style10 style14">View  and Authorize Auditors..</span></td>
            </tr>
          </table>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <table width="972" align="center"  cellpadding="0" cellspacing="0"  ">
            ...
            <%
					  ...
					  String s1,s2,s3,s4,s5,s6,s7;
						...
						try 
						{
						   	String query="select * from auditor where bank='"+bank+"'"; 
            ...
            <tr>
              ...
              <td width="159" rowspan="1" align="center" valign="middle" ><div style="margin:10px 13px 10px 13px;" > <a class="#" id="img1" href="#" >
                  <input  name="image" type="image" src="user_Pic.jsp?picture=<%="userimage1"%>&amp;id=<%=i%>" style="width:120px; height:120px;" />
              </a></div></td>
              ...
              <td valign="middle" height="0" style="color:#000000;"align="center"><div align="center">
                  <div align="center" class="style20 style37 style46"><a href="V_UserStatus2.jsp?val=<%="login"%>&amp;name=<%=s1%>" class="style96 style30 style87"><strong>waiting</strong></a></div>
              </div></td>
              <%
						}
						else
              ...
              <%}
						...
						%>
              <td valign="middle" height="0" style="color:#000000;"align="center"><div align="center">
                  <div align="center" class="style20 style37 style46"><a href="V_UserStatus2.jsp?val=<%="ac_creation"%>&amp;name=<%=s1%>" class="style96 style30 style87"><strong>waiting</strong></a></div>
              </div></td>
              <%
						}
						else
