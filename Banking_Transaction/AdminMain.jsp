    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="img">
            <div align="center">
              <p class="style41">Secure financial transactions without the need of tokens and by using block chain technology</p>
              <p>&nbsp;</p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu style40">
            ...
            <li class="style13"><a href="AdminProfile.jsp">Profile</a></li>
            ...
            <li><a href="A_View_MiniStatement1.jsp">View Money Transfer Request and Process Statement Via Agent </a></li>
		   ...
		   <li><a href="A_View_MoneyDeposit_Requests.jsp">View Money Deposit Request and Process Statement Via Auditor </a></li>
            ...
            <li><a href=" Attckerdetails.jsp"><span>View All Attacked Account Details..</span></a></li>
