...
<head>
<title>View_Money_Requests</title>
      ...
      <div class="sb_menu">
        <div class="gadget">
          <table width="544" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="536"><span class="style10 style14"><span class="style99">View  All Deposit Requests and Approve Via Agent !!!</span>..</span></td>
            </tr>
          </table>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <table width="1131" align="center"  cellpadding="0" cellspacing="0"  ">
            ...
            <%
					  String s1,s2,s3,s4,s5,s6,s7,s8;
						...
						String aname=(String)application.getAttribute("aname");
						   	...
						   	String query="select * from agent_deposit where agent='"+aname+"' "; 
            ...
            <tr>
              ...
              <td valign="middle" height="84" style="color:#000000;"align="center"><div align="center">
                  <div align="center" class="style20 style37 style46"><a href="Ag_DepositMoneyStatus.jsp?uname=<%=s1%>&bank=<%=s2%>&acno=<%=s3%>&amount=<%=s4%>" class="style96 style30 style87"><strong> Send To Bank </strong></a></div>
              </div></td>
              <%
