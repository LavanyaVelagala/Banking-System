...
<head>
<title>Agent_Re_Login  Page</title>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="AgentAuthentication.jsp" enctype="multipart/form-data">
            <table width="570" border="0" align="left" cellpadding="2" cellspacing="2">
              ...
              <tr>
                ...
                <td><input name="imageField" type="submit"  class="LOGIN" id="imageField" value="Login" />
                    <span class="style38">New User?</span><span class="style10"><a href="AgentRegister.jsp" class="style30"> Register </a></span></td>
              </tr>
            </table>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            ...
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p class="style12"><a href="AgentLogin.jsp" class="style36">Back</a></p>
          </form>
        </div>
      </div>
      <div class="sidebar">
