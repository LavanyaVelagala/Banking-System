    ...
    <div class="content_resize">
      <div class="sb_menu">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <p>&nbsp;</p>
          <form action="attacksuccess.jsp" method="post">
            <table width="435" align="left"  cellpadding="0" cellspacing="0" class="sb_menu">
              ...
              <%
					  ...
					  String s1,s2,s3,s4,s5,s6,s7;int xy=0;
						int i=0,j=1;
						try 
						{
						   	String query="select * from accountrequest where (user='"+attackuser+"' and bank='"+attackbank+"')"; 
              ...
              <tr>
                ...
                <td valign="middle" height="41" style="color: #2c83b0;"><div align="left">
                    <input type="text" name="amount" value="<%=xy%>" />
      ...
      <div class="clr">
        ...
        <table width="496" border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td width="488"><div align="left"><a href="attacker.jsp" class="style95">Back</a></div></td>
          </tr>
        </table>
        <p>&nbsp;</p>
      </div>
