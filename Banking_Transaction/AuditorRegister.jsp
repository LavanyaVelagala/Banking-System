...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="left">Welcome to Auditor Register </h2>
          <p>&nbsp;</p>
          <form action="AuditorRegisterStatus.jsp" method="post" id="" enctype="multipart/form-data">
            ...
            <br/>
            <br/>
            <label for="name"><span class="style35"> Auditor Name (required)</span></label>
            <p class="style35">
          ...
          <p class="style37">&nbsp;</p>
          <p class="style37"><a href="AuditorLogin.jsp">Back</a></p>
        </div>
      </div>
      <div class="sidebar">
