...
<head>
<title>Via agent money Transactions</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style15">Welcome To  money  transfer and deposit Via Agent </h2>
          <form id="form1" name="form1" method="post" action="">
			...
			<p align="center" class="style17"><span class="style15">
			<p align="center"><a href="U_DepositMoney.jsp">1.Deposit Amount<br />
                    </a><a href="U_DepositMoney.jsp"><br />
                      </a><a href="U_TransferMoney1.jsp">2.Transfer Amount<br />
                      <br />
            <p align="center" class="style17">&nbsp;</p>
            <p class="style12"><a href="UserMain.jsp" class="style13">Back</a></p>
          </form>
          <p>&nbsp;</p>
          <div class="clr"></div>
          <div class="img"></div>
