...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="AgentMain.jsp"><span>Home Page</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="article">
        <h2 class="style10 style14">Agent <span class="style30"><%=(String)application.getAttribute("uname")%></span>'s Profile.. </h2>
        <p>&nbsp;</p>
        <div class="sidebar">
          ...
          <div class="gadget">
            ...
            <div class="clr"></div>
            <ul class="sb_menu">
              <li class="style13"><a href="AgentMain.jsp">Home</a></li>
        ...
        <table width="519" border="1.5" align="left"  cellpadding="0" cellspacing="0"  >
          ...
          <%
						...
						try 
						{
						   	String query="select * from account_request where username='"+user+"' and bank='"+bank+"'"; 
          ...
          <tr>
            <td width="226" rowspan="6" ><div class="style7 style26" style="margin:10px 13px 10px 13px;" >
                <p><a class="#" id="img1" href="#" >
                  <input  name="image" type="image" src="user_Pic.jsp?picture=<%="userimage2"%>&amp;id=<%=i%>" style="width:180px; height:140px;" />
                </a></p>
              <p><a class="#" href="#" ><br/>
                      <input  name="image2" type="image" src="user_Pic.jsp?picture=<%="fingerprint2"%>&amp;id=<%=i%>" style="width:180px; height:140px;" />
                </a></p>
            </div></td>
          </tr>
          <tr>
        ...
        <p align="right">&nbsp;</p>
        <p align="left"><a href="AgentMain.jsp" class="style11"></a><a href="AgentMain.jsp" class="style11"></a></p>
        <div class="clr">
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p><a href="AgentMain.jsp" class="style11">Back</a></p>
          <p>&nbsp;</p>
        </div>
      </div>
      <div class="clr"></div>
