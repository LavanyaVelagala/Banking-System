      ...
      <div class="mainbar">
        <div class="article">
          <form id="form1" name="form1" method="post" action="AdminAuthentication.jsp">
            <div class="article">
              <h2 class="style30"><span class="style29">Invalid Login Details, Please Try Again!!</span></h2>
              <div class="clr"></div>
              <p>&nbsp;</p>
              <table width="570" border="0" align="left" cellpadding="2" cellspacing="2">
                ...
                <tr>
                  <td height="46" align="center" valign="middle"><span class="style35">
                    <label for="label"> </label>
                      ...
                      <label for="label">
                      <div align="center"><span class="style35"><strong>Admin Name (required)</strong></span></div>
                    </label>
                      <span class="style35">
                      <label for="name"></label>
                    </span></td>
                  <td width="371"><input id="name" name="userid1" class="text" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input name="imageField" type="submit"  class="LOGIN" id="imageField" value="Login" />
                      <span class="style38">New Admin?</span><span class="style10"><a href="AdminRegister.jsp" class="style30"> Register </a></span></td>
                </tr>
              </table>
              <div class="clr"></div>
            </div>
            <p class="style12"><a href="index.html" class="style13">Back</a></p>
          </form>
          </div>
      </div>
      <div class="sidebar">
