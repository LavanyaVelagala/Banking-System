...
<head>
<title>User Re_Login  Page</title>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="UserAuthentication.jsp" enctype="multipart/form-data">
            <table width="570" border="0" align="left" cellpadding="2" cellspacing="2">
              ...
              <tr>
                ...
                <td><input name="imageField" type="submit"  class="LOGIN" id="imageField" value="Login" />
                    <span class="style38">New User?</span><span class="style11"><a href="UserRegister.jsp" class="style30"> Register </a></span></td>
              </tr>
              <tr>
                <td height="49"></td>
            ...
            <p class="style12">&nbsp;</p>
            <p class="style12"><a href="UserLogin.jsp" class="style36">Back</a></p>
          </form>
          </div>
      </div>
      <div class="sidebar">
